...
export const HEADER_ACTION_BTN =
  "pixel-btn font-body font-bold bg-[var(--pixel-surface)] text-[var(--pixel-text)] border-[3px] border-[var(--pixel-border-soft)] hover:bg-[var(--pixel-surface-2)] px-2 py-1.5 text-xs rounded-[8px] min-w-[3.25rem] h-8 sm:px-3.5 sm:py-2 sm:text-sm sm:rounded-[10px] sm:min-w-[5.25rem] sm:h-10 inline-flex items-center justify-center shrink-0 whitespace-nowrap";
